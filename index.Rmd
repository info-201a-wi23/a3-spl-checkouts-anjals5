...
For this graph, I wanted to analyze the trends in the popularity of Booktok books compared to their original publishing date. I included three books I knew were extremely popular and examined how their social media popularity impacted their eBook checkouts. I decided to focus on eBooks because they have increasingly gained more popularity since they are more accessible alternative to physical books. I was curious about how Booktok and other social media would impact the number of eBooks that were checked out. 
...
This graph demonstrates that the novel peaked after the movie was released in June 2014.The blue line represents the date of movie release. The eBook checkouts had steadily increased before the movie's release date after being published in 2012. However, the movie release led to a much steeper increase than the trend it had initially been on. Then it reached an all-time peak before steadily decreasing in popularity. The date with the absolute most checkouts was October of 2014, 4 months after the movie's release and two years after the original publishing of the book. 
